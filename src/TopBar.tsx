...
export default function TopBar({ activeModule, setModule }: Props) {
  ...
  return (
    <div ref={ref} className="fixed top-4 right-[72px] md:top-8 md:right-[88px] z-40" style={{ zIndex: 40 }}>
      <div className="relative">
        ...
        {open && (
          <div role="menu" className="absolute right-full top-0 mr-2 w-56 rounded-2xl overflow-hidden shadow-2xl"
